/* ============================================================
   UTILS.JS — Допоміжні функції (форматування, валідація тощо)
   ============================================================ */
 ...
 * @param {Object} item — об'єкт квартири
 * @returns {string} HTML-рядок
 */
function buildAvailabilityHTML(item) {
    ...
    // always_available = false, але дат немає — вважаємо зайнятою
    return `
        <div class="availability-block">
